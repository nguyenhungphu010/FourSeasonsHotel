...
import BookingCalendar from './component/content/admin/BookingCalendar';
//#endregion
                                        ...
                                        <>
                                            {
                                                user.roleId == '3' ?
                                                    <>
                                                        ...
                                                        <Route path='/reception/bookingCalendar' exact element={<BookingCalendar />}></Route>
                                                    ...
                                                    user.roleId == '2' ?
                                                        <>
                                                            ...
                                                            <Route path='/manager/bookingCalendar' exact element={<BookingCalendar />}></Route>
