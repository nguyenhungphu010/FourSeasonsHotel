...
export default function ManageGuestOfManager() {
            ...
            render: (record) => {
                return (
                    <>
                        ...
                        ></Button>{" "}
                        &nbsp;
                        {/* <Button onClick={() => handleChangeStatusDeActivate(record)} type="primary" icon={PoweroffOutlined} style={{color: 'red'}}></Button> */}
                        {record.status == "1" ? (
                            <Button
    ...
    const handleChangeStatusDeActivate = (record) => {
        ...
        const url = process.env.REACT_APP_SERVER_HOST + "ManageGuest/" + deleteId;
        const cleanedUrl = url.replace(/`/g, "");
        Modal.confirm({
            title: "Are you sure to Deactivate account: " + data.email + " ?",
            okText: "DeaActivate",
            okType: "danger",
            onOk: () => {
                data.status = "0";
    ...
    const handleChangeStatusActivate = (record) => {
        ...
        const cleanedUrl = url.replace(/`/g, "");
        Modal.confirm({
            title: "Are you sure to Activate account: " + data.email + " ?",
            okText: "Activate",
            okType: "default",
            onOk: () => {
                data.status = "1";
